...
export default function TermsScreen() {
  ...
  const TERMS_URL = 'https://raw.githubusercontent.com/m0hamed-ux/tribblebook-info/main/terms.md'
  ...
  const load = useCallback(async () => {
    try {
      ...
      setError('تعذر تحميل الشروط. تحقق من الاتصال وحاول مرة أخرى.')
    } finally {
      setLoading(false)
    }
  }, [])
    ...
    <View style={[appStyles.container, { paddingTop: 8 }]}>      
      <View style={s.header}>
        ...
        <View style={{ alignItems: 'center', flex: 1 }}>
          ...
          <Text style={s.headerSubtitle}>اقرأ بنود الاستخدام وحقوقك</Text>
        </View>
      ...
      <View style={s.content}>
        {loading && (
          <View style={s.center}>
            ...
            <Text style={[s.headerSubtitle, { marginTop: 8 }]}>جارٍ تحميل الشروط…</Text>
          </View>
        )}
        {!!error && !loading && (
