    ...
    return (
        <View style={style.constainer}>
            ...
            <View style={{paddingHorizontal: 8}}>
                <Text
                    style={{fontFamily: 'bold', fontSize: 16, color: 'black', marginBottom: 0, textAlign: "right"}}
                    selectable={true}
                    onLongPress={() => {Clipboard.setString(title); ToastAndroid.show("تم نسخ", ToastAndroid.SHORT);}}
                >
                    {title}
                </Text>
                {content && (
